...
public class DemoMigrator {
  ...
  public static void main(String[] args) {
    ...
    migStepDescriptor1.addTrafoDescriptor((new TrafoDescriptorBuilder().addDependencyFromComponent("Impl").toComponent("Tables")).build());
    ...
    //        ("API-Adapter").build());
    migStepDescriptor2.addTrafoDescriptor(new TrafoDescriptorBuilder().addDependencyFromComponent("API-Adapter").toComponent("API").build());
